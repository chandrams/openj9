...
public class TestOpenJ9DiagnosticsMXBean {
	...
	private static boolean zOS = "z/OS".equalsIgnoreCase(os) ? true : false;
	 ...
	 */	
	@Test
	private void testLocal_triggerDumpToFile() throws InvalidOptionException, FileNotFoundException, IOException, ClassNotFoundException, NoSuchMethodException, 
	 ...
	 */
	@Test
	private void testRemote_triggerDumpToFile() throws InvalidOptionException, FileNotFoundException, IOException, ClassNotFoundException, NoSuchMethodException, 
								IllegalAccessException, InvocationTargetException {
	 ...
	 */	
	private void triggerDumpToFile(OpenJ9DiagnosticsMXBean diagBean, String test) throws InvalidOptionException, FileNotFoundException, IOException, ClassNotFoundException,
					...
					if (isZOSSystemAgent(agent)) {
						String actual_dsn = "";
                                                ...
                                                if (fileName.endsWith("X&DS")) {
                                                        ...
                                                        actual_dsn = fileName.replace("X&DS", "X001");
                                                } else {
